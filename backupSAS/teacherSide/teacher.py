...
class MainApp(MDApp):
    ...
    def updateAttendanceSheet(self):
        try:
            ...
            if "error" in AttendanceListFromServer:
                ...
                attendanceScreen = sm.get_screen("attendance")
                self.load_table(attendanceScreen)  # adds data table , stop and present button
        except Exception as e:
            print(e)
    ...
    def manualPresent(self, *args):
        ...
        try:
            for text in self.attendanceToBeDone:
                ...
                client_teacher.markAttendance(self.teacherId, self.classId, text)
        except:
    ...
    def startCallback(self, *args):
        ...
        self.attendanceCodeLabel.text = "Attendance Code: " + str(self.attendanceId)
